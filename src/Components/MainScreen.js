...
class MainScreen extends Component {
  ...
  state = {
    ...
    aptmt: [{ "buildingName": "Heart", "apartmentNumber": "2101", "roomNumber": "2", "fullName": "Husnan Sultan", "intake": "December 2018" , "startDate": "02/12/2018" , "endDate": "04/2/2019"},
  ...
  //   // axios.get(`http://localhost:8080/getAllApartments`).then(response => {
